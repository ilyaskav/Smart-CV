$(function () {
    ...
    $(document).on('click', '#addDuty', function () {
        ...
        var html = [
            ...
            '   </div>',
            '   <div class="col-md-2 delete-line">',
    ...
    $(document).on('click', 'p.remove-duty', function () {
        ...
        const dutyId = duty.find('input[type="hidden"]').val();
    ...
    $('#addWorkPlace').on('click', function () {
        ...
        var workPlace = row.closest('form').find('div.workplace').last();
        ...
        var html = [
            '<div class="workplace gray-bottom-line">',
            ...
            '        <label class="col-md-2 col-form-label">Место работы*</label>',
            '        <div class="col-md-9">',
            ...
            '    </div>',
            '    <div class="form-group row">',
            '        <label class="col-md-2 col-form-label">Обязанности*</label>',
            '    <div class="duties col-md-9">',
            '       <div class="row duty">',
            '            <div class="col-md-12">',
    ...
    $(document).on('click', 'p.remove-workplace', function () {
        ...
        if (workplace.find('input[type="hidden"]').val() == '') {
            workplace.remove();
        }
        else {
            var managerId = getManagerIdFromURI();
