$(function () {
    ...
    $('#addInstitution').on('click', function () {
        ...
        var institutionSection = $(this).closest('.form-group').prev().find('input[type = "hidden"]').attr('name');
        ...
        var html = [
            '<div class="institution gray-bottom-line">',
            ...
            '        <div class="col-md-9">',
            '            <div class="input-daterange input-group datePicker-month">',
    ...
    $(document).on('click', '.remove-institution', function () {
        var institutionId = $(this).closest('div.institution').find('input[type = "hidden"]').val();
        if (institutionId) {
            var managerId = getManagerIdFromURI();
            window.location.href = '/Resume/RemoveInstitution/?managerId=' + managerId + '&institutionId=' + institutionId;
        }
        else {
            $(this).closest('div.institution').remove();
        }
    });
