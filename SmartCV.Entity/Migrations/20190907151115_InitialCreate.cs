    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonalQualities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonalQualities_Resumes_ResumeId",
                        column: x => x.ResumeId,
                        principalTable: "Resumes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Duties_Workplaces_WorkPlaceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechStack = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_Workplaces_WorkPlaceId",
                        column: x => x.WorkPlaceId,
                        principalTable: "Workplaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Duties_WorkPlaceId",
                table: "Duties",
                column: "WorkPlaceId");

            migrationBuilder.CreateIndex(
                name: "IX_Institutions_ResumeId",
                table: "Institutions",
                column: "ResumeId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonalQualities_ResumeId",
                table: "PersonalQualities",
                column: "ResumeId");

            migrationBuilder.CreateIndex(
                name: "IX_Projects_WorkPlaceId",
                table: "Projects",
                column: "WorkPlaceId");
